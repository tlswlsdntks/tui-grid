...
> **참조** > `min`, `max`는 `v4.5.0` 이상부터 사용할 수 있는 옵션이다.
...
> **참조** > `regExp`는 `v4.5.0` 이상부터 사용할 수 있는 옵션이다.
...
> **참조** > `meta` 정보 반환은 `v4.14.0` 이상부터 사용할 수 있다.
...
> **참조** > `errorInfo`는 `v4.14.0` 이상부터 사용할 수 있는 속성이다.
